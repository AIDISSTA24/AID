...
class Access:
    ...
    async def get(self, end_url):
        ...
        """
        return self._perform_request(self.session.get, end_url)
    ...
    async def post(self, end_url, payload=None):
        ...
        return self._perform_request(self.session.post, end_url, data=data)
    ...
    async def put(self, end_url, payload=None):
        ...
        """
        data = json.dumps(payload) if payload is not None else None
        return self._perform_request(self.session.put, end_url, data=data)
    ...
    async def delete(self, end_url, payload=None):
        ...
        """
        data = json.dumps(payload) if payload is not None else None
        return self._perform_request(self.session.delete, end_url, data=data)
