class Storage:
    ...
    async def check_partition(self, id):
        ...
        id : `int`
        """
        return self._access.put(f"storage/partition/{id}/check")
    ...
    async def eject_disk(self, disk_id, eject_data=None):
        ...
        return self._access.put(f"storage/disk/{disk_id}", eject_data)
    ...
    async def format_partition(self, id, format_data):
        ...
        format_data : `dict`
        """
        return self._access.put(f"storage/partition/{id}/format", format_data)
