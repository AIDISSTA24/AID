...
class Lan:
    ...
    async def delete_lan_host(self, host_id, interface="pub"):
        ...
        Delete lan host
        """
        self._access.delete(f"lan/browser/{interface}/{host_id}/")
    ...
    async def wake_lan_host(self, wol=wol_schema, interface="pub"):
        ...
        Wake lan host
        """
        return self._access.post(f"lan/wol/{interface}/", wol)
