...
class Call:
    ...
    async def delete_call_log(self, log_id):
        ...
        log_id : `int`
        """
        self._access.delete(f"call/log/{log_id}")

    async def delete_calls_log(self):
        """
        Delete calls log
        """
        self._access.delete("call/log/delete_all/")

    async def get_call_log(self, log_id):
        """
        Get call log
        """
        return self._access.get(f"call/log/{log_id}")
    ...
    async def update_call_log(self, log_id, call_entry):
        ...
        call_entry : `dict`
        """
        return self._access.put(f"call/log/{log_id}", call_entry)
