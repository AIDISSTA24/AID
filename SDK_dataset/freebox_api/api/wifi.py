class Wifi:
    ...
    async def create_wifi_custom_key(
        ...
        """
        return self._access.post("wifi/custom_key/", wifi_custom_key_data)

    async def create_wifi_mac_filter(self, wifi_mac_filter=wifi_mac_filter_schema):
        """
        Create wifi mac filter
        """
        return self._access.post("wifi/mac_filter/", wifi_mac_filter)
    ...
    async def edit_wifi_access_point(self, ap_id, wifi_ap_configuration_data):
        ...
        """
        return self._access.put(f"wifi/ap/{ap_id}", wifi_ap_configuration_data)

    async def edit_wifi_bss(self, bss_id, wifi_bss_data):
        """
        Edit wifi bss
        """
        return self._access.put(f"wifi/bss/{bss_id}", wifi_bss_data)
    ...
    async def reset_wifi_configuration(self):
        ...
        """
        self._access.put("wifi/config/reset/")
    ...
    async def start_wifi_access_point_neighbors_scan(self, ap_id):
        ...
        """
        self._access.post("wifi/ap/{0}/neighbors/scan/")
    ...
    async def start_wps_session(
        ...
        Start wps session
        """
        return self._access.post("wifi/wps/start/", start_wps_session_data)
    ...
    async def stop_wps_session(
        ...
        stop wps session
        """
        self._access.post("wifi/wps/stop/", stop_wps_session_data)
