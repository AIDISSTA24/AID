...
class Airmedia:
    ...
    async def send_airmedia(
        ...
        airmedia_data : `dict`
        """
        self._access.post(f"airmedia/receivers/{receiver_name}/", airmedia_data)
    ...
    async def set_airmedia_configuration(
        ...
        """
        return self._access.put("airmedia/config/", airmedia_config)
    ...
    async def update_airmedia_configuration(
        ...
        return self.set_airmedia_configuration(config)
