...
class Fs:
    ...
    async def delete_file_task(self, task_id):
        ...
        Delete file task
        """
        return self._access.delete(f"fs/tasks/{task_id}")
    ...
    async def get_file_info(self, path):
        ...
        return self._access.get(f"fs/ls/{path_b64}")
    ...
    async def get_hash(self, hash_id):
        ...
        hash_id : `int`
        """
        return self._access.get(f"fs/tasks/{hash_id}/hash")
    ...
    async def ls(self):
        ...
        List directory
        """
        return [i["name"] for i in self.list_file(self._path)]
    ...
    async def set_file_task_state(self, task_id, update_task_state):
        ...
        Set file task state
        """
        return self._access.put(f"fs/tasks/{task_id}", update_task_state)
