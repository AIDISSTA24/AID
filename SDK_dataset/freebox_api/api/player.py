...
class Player:
    ...
    async def get_player_status(
        ...
        if player_id is None:
            player_id = self._get_default_player_id()
    ...
    async def update_player_volume(
        ...
        self.set_player_volume(player_data, player_id)
    ...
    async def execute_media_control_command(
        ...
        player_id : `int` , optional
            , Default to `None`
        """
        return self.send_media_control({"name": command}, player_id)
    ...
    async def open_media_url(
        ...
        player_id : `int` , optional
            , Default to `None`
        """
        return self.set_media_url({"url": media_url}, player_id)
