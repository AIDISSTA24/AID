...
class AbstractAuth(ABC):
    ...
    async def async_get_creds(self) -> Credentials:
        ...
        token = self.async_get_access_token()
    ...
    async def request(
        ...
        **kwargs: Mapping[str, Any] | None,
        ...
        if AUTHORIZATION_HEADER not in headers:
            try:
                access_token = self.async_get_access_token()
    ...
    async def _request(
        ...
        **kwargs: Mapping[str, Any] | None,
        ...
        return self._websession.request(method, url, **kwargs, headers=headers)
    ...
    async def get(
        ...
        return AbstractAuth._raise_for_status(resp)
    ...
    async def _raise_for_status(resp: aiohttp.ClientResponse) -> aiohttp.ClientResponse:
        ...
        detail = AbstractAuth._error_detail(resp)
        try:
