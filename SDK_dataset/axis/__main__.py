...
async def axis_device(
    ...
    try:
        async with async_timeout.timeout(5):
            device.vapix.initialize_users()
            device.vapix.load_user_groups()
        device.vapix.initialize_event_instances()
...
async def main(
    ...
    device = axis_device(host, port, username, password)
