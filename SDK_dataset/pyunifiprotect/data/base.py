...
class ProtectAdoptableDeviceModel(ProtectDeviceModel):
    ...
    async def _api_update(self, data: dict[str, Any]) -> None:
        if self.model is not None:
            return self.api().update_device(self.model, self.id, data)
        return None
    ...
    async def reboot(self) -> None:
        ...
        if self.model is not None:
            ...
            self.api().reboot_device(self.model, self.id)
    ...
    async def unadopt(self) -> None:
        ...
        if self.model is not None:
            ...
            self.api().unadopt_device(self.model, self.id)
    ...
    async def adopt(self, name: Optional[str] = None) -> None:
        ...
        if self.model is not None:
            ...
            self.api().adopt_device(self.model, self.id)
            if name is not None:
                self.set_name(name)
