...
class Light(ProtectMotionDeviceModel):
    ...
    async def set_paired_camera(self, camera: Optional[Camera]) -> None:
        ...
        async with self._update_lock:
            ...
            self.save_device(data_before_changes, force_emit=True)
...
class Camera(ProtectMotionDeviceModel):
    ...
    async def get_snapshot(
        ...
        return self.api.get_camera_snapshot(self.id, width, height, dt=dt)
    ...
    async def get_package_snapshot(
        ...
        return self.api.get_package_camera_snapshot(self.id, width, height, dt=dt)
    ...
    async def get_video(
        ...
        return self.api.get_camera_video(
            self.id,
            start,
            end,
            channel_index,
    ...
    async def set_chime_type(self, chime_type: ChimeType) -> None:
        ...
        self.set_chime_duration(timedelta(milliseconds=chime_type.value))
    ...
    async def set_person_detection(self, enabled: bool) -> None:
        ...
        return self._set_object_detect(SmartDetectObjectType.PERSON, enabled)
    ...
    async def set_license_plate_detection(self, enabled: bool) -> None:
        ...
        return self._set_object_detect(
    ...
    async def set_package_detection(self, enabled: bool) -> None:
        ...
        return self._set_object_detect(SmartDetectObjectType.PACKAGE, enabled)
    ...
    async def set_smoke_detection(self, enabled: bool) -> None:
        ...
        return self._set_audio_detect(SmartDetectAudioType.SMOKE_CMONX, enabled)
    ...
    def create_talkback_stream(
        ...
        Use either `stream.run_until_complete()` or `stream.start()` to start subprocess command
    ...
    async def play_audio(
        ...
        if blocking:
            self.wait_until_audio_completes()
...
class Sensor(ProtectAdoptableDeviceModel):
    ...
    async def clear_tamper(self) -> None:
        ...
        self.api.clear_tamper_sensor(self.id)
...
class Doorlock(ProtectAdoptableDeviceModel):
    ...
    async def calibrate(self) -> None:
        ...
        self.api.calibrate_lock(self.id)
...
class Chime(ProtectAdoptableDeviceModel):
    ...
    async def play(self) -> None:
        ...
        self.api.play_speaker(self.id)

    async def play_buzzer(self) -> None:
        """Plays chime buzzer"""

        self.api.play_buzzer(self.id)
