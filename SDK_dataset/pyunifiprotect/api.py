...
class BaseApiClient:
        ...
        **kwargs: Any,
        ...
        for attempt in range(2):
            try:
                ...
                response = req_context.__aenter__()
    ...
    async def api_request_raw(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            data: Optional[bytes] = response.read()
            response.release()
    ...
    async def authenticate(self) -> None:
        ...
        async with self._auth_lock:
            ...
            response = self.request("post", url=url, json=auth)
            self.headers = {
...
class ProtectApiClient(BaseApiClient):
    ...
    async def update(self, force: bool = False) -> Optional[Bootstrap]:
        ...
        if self._bootstrap is None or now - self._last_update > DEVICE_UPDATE_INTERVAL:
            ...
            self._bootstrap = self.get_bootstrap()
            self._last_update = now
            self._last_update_dt = now_dt

        self.async_connect_ws(force)
    ...
    async def get_events_raw(
        ...
        return self.api_request_list("events", params=params)
    ...
    async def get_bootstrap(self) -> Bootstrap:
        ...
        data = self.api_request_obj("bootstrap")
    ...
    async def get_devices_raw(self, model_type: ModelType) -> list[dict[str, Any]]:
        ...
        return self.api_request_list(f"{model_type.value}s")
    ...
    async def get_devices(
        ...
        for obj_dict in self.get_devices_raw(model_type):
    ...
    async def get_cameras(self) -> list[Camera]:
        ...
        """
        return cast(list[Camera], self.get_devices(ModelType.CAMERA, Camera))
    ...
    async def get_lights(self) -> list[Light]:
        ...
        """
        return cast(list[Light], self.get_devices(ModelType.LIGHT, Light))
    ...
    async def get_sensors(self) -> list[Sensor]:
        ...
        """
        return cast(list[Sensor], self.get_devices(ModelType.SENSOR, Sensor))
    ...
    async def get_doorlocks(self) -> list[Doorlock]:
        ...
        return cast(
            list[Doorlock],
            self.get_devices(ModelType.DOORLOCK, Doorlock),
        )
    ...
    async def get_chimes(self) -> list[Chime]:
        ...
        """
        return cast(list[Chime], self.get_devices(ModelType.CHIME, Chime))
    ...
    async def get_viewers(self) -> list[Viewer]:
        ...
        """
        return cast(list[Viewer], self.get_devices(ModelType.VIEWPORT, Viewer))
    ...
    async def get_bridges(self) -> list[Bridge]:
        ...
        """
        return cast(list[Bridge], self.get_devices(ModelType.BRIDGE, Bridge))
    ...
    async def get_liveviews(self) -> list[Liveview]:
        ...
        return cast(
            list[Liveview],
            self.get_devices(ModelType.LIVEVIEW, Liveview),
        )
    ...
    async def get_device_raw(
        ...
        return self.api_request_obj(f"{model_type.value}s/{device_id}")
    ...
    async def get_device(
        ...
        obj = create_from_unifi_dict(
            self.get_device_raw(model_type, device_id),
            api=self,
        )
    ...
    async def get_event(self, event_id: str) -> Event:
        ...
        """
        return cast(Event, self.get_device(ModelType.EVENT, event_id, Event))
    ...
    async def get_camera(self, device_id: str) -> Camera:
        ...
        """
        return cast(Camera, self.get_device(ModelType.CAMERA, device_id, Camera))
    ...
    async def get_light(self, device_id: str) -> Light:
        ...
        """
        return cast(Light, self.get_device(ModelType.LIGHT, device_id, Light))
    ...
    async def get_sensor(self, device_id: str) -> Sensor:
        ...
        """
        return cast(Sensor, self.get_device(ModelType.SENSOR, device_id, Sensor))
    ...
    async def get_doorlock(self, device_id: str) -> Doorlock:
        ...
        return cast(
            Doorlock,
            self.get_device(ModelType.DOORLOCK, device_id, Doorlock),
        )
    ...
    async def get_chime(self, device_id: str) -> Chime:
        ...
        """
        return cast(Chime, self.get_device(ModelType.CHIME, device_id, Chime))
    ...
    async def get_viewer(self, device_id: str) -> Viewer:
        ...
        return cast(
            Viewer,
            self.get_device(ModelType.VIEWPORT, device_id, Viewer),
        )
    ...
    async def get_bridge(self, device_id: str) -> Bridge:
        ...
        """
        return cast(Bridge, self.get_device(ModelType.BRIDGE, device_id, Bridge))
    ...
    async def get_liveview(self, device_id: str) -> Liveview:
        ...
        return cast(
            Liveview,
            self.get_device(ModelType.LIVEVIEW, device_id, Liveview),
        )
    ...
    async def _stream_response(
        ...
        if iterator_callback is not None:
            iterator_callback(total, None)
        async for chunk in response.content.iter_chunked(chunk_size):
            step = len(chunk)
            current += step
            if iterator_callback is not None:
                iterator_callback(total, chunk)
    ...
    async def get_camera_video(
        ...
        if output_file is not None:
            async with aiofiles.open(output_file, "wb") as output:
                ...
                self._stream_response(r, chunk_size, callback, progress_callback)
        else:
    ...
    async def _get_image_with_retry(
        ...
        **kwargs: Any,
        ...
        while data is None and now < timeout:
            data = self.api_request_raw(path, raise_exception=False, **kwargs)
            if data is None:
                asyncio.sleep(0.5)
                now = time.monotonic()
    ...
    async def get_event_thumbnail(
        ...
        return self._get_image_with_retry(
    ...
    async def get_event_smart_detect_track_raw(self, event_id: str) -> dict[str, Any]:
        ...
        return self.api_request_obj(f"events/{event_id}/smartDetectTrack")

    async def get_event_smart_detect_track(self, event_id: str) -> SmartDetectTrack:
        """Gets raw Smart Detect Track for a Smart Detection"""

        data = self.api_request_obj(f"events/{event_id}/smartDetectTrack")
    ...
    async def close_lock(self, device_id: str) -> None:
        ...
        self.api_request(f"doorlocks/{device_id}/close", method="post")

    async def open_lock(self, device_id: str) -> None:
        """Open doorlock (unlock)"""

        self.api_request(f"doorlocks/{device_id}/open", method="post")
    ...
    async def play_speaker(self, device_id: str) -> None:
        ...
        self.api_request(f"chimes/{device_id}/play-speaker", method="post")

    async def play_buzzer(self, device_id: str) -> None:
        """Plays chime tones on a chime"""

        self.api_request(f"chimes/{device_id}/play-buzzer", method="post")

    async def clear_tamper_sensor(self, device_id: str) -> None:
        """Clears tamper status for sensor"""

        self.api_request(f"sensors/{device_id}/clear-tamper-flag", method="post")
    ...
    async def get_release_versions(self) -> set[Version]:
        ...
        for url in PROTECT_APT_URLS:
            try:
                versions |= self._get_versions_from_api(url)
            except NvrError:
