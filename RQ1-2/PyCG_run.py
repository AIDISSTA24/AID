...
if __name__ == "__main__":
    ...
    with open('RQ1-2\\PyCG_results\\miio.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #2.broadlink
    command = [r'SDK_dataset\broadlink\light.py']
    with open('RQ1-2\\PyCG_results\\broadlink.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #3.kasa
    command = ['SDK_dataset\kasa\smartbulb.py']
    with open('RQ1-2\\PyCG_results\\kasa.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\ring_doorbell.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #5.blinkpy
    command = [r'SDK_dataset\blinkpy\api.py',
        r'SDK_dataset\blinkpy\auth.py', ] 
    with open('RQ1-2\\PyCG_results\\blinkpy.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pywizlight.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #7.amcrest
    command = [r'SDK_dataset\amcrest\http.py',
        r'SDK_dataset\amcrest\motion_detection.py', ]  
    with open('RQ1-2\\PyCG_results\\amcrest.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #8.pyvesync
    command = [r'SDK_dataset\pyvesync\helpers.py',
        r'SDK_dataset\pyvesync\vesyncfan.py', ]   
    with open('RQ1-2\\PyCG_results\\pyvesync.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pyhomematic.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\flux_led.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #11.pylutron_caseta
    command = [r'SDK_dataset\pylutron_caseta\smartbridge.py',]   
    with open('RQ1-2\\PyCG_results\\pylutron_caseta.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pysmartthings.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #13.yeelight
    command = [r'SDK_dataset\yeelight\main.py',]   
    with open('RQ1-2\\PyCG_results\\yeelight.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #14.pyezviz
    command = [r'SDK_dataset\pyezviz\camera.py',
               r'SDK_dataset\pyezviz\client.py']   
    with open('RQ1-2\\PyCG_results\\pyezviz.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pybotvac.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\wled.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\switchbot.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\PyTado.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\aiohue.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pydeconz.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #21.pyfritzhome
    command = [r'SDK_dataset\pyfritzhome\fritzhome.py',]   
    with open('RQ1-2\\PyCG_results\\pyfritzhome.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pyecobee.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\env_canada.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #24.pyvera
    command = [r'SDK_dataset\pyvera\__init__.py',]   
    with open('RQ1-2\\PyCG_results\\pyvera.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\reolink_aio.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pyoverkiz.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\rflink.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\decora_wifi.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\aioshelly.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\homeconnect.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pyeconet.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    command = [r'SDK_dataset\pyisy\connection.py',
        ...
        r'SDK_dataset\pyisy\nodes\node.py',
        r'SDK_dataset\pyisy\nodes\nodebase.py']
    with open('RQ1-2\\PyCG_results\\pyisy.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #33.yalexs
    command = [r'SDK_dataset\yalexs\activity.py',
        r'SDK_dataset\yalexs\api.py']
    with open('RQ1-2\\PyCG_results\\yalexs.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #34.elgato
    command = [r'SDK_dataset\elgato\elgato.py']
    with open('RQ1-2\\PyCG_results\\elgato.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\motioneye_client.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\apyhiveapi.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pyatmo.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #38.pydroid_ipcam
    command = [r'SDK_dataset\pydroid_ipcam\exceptions.py',
        r'SDK_dataset\pydroid_ipcam\__init__.py']
    with open('RQ1-2\\PyCG_results\\pydroid_ipcam.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #39.haphilipsjs
    command = [r'SDK_dataset\haphilipsjs\__init__.py']
    with open('RQ1-2\\PyCG_results\\haphilipsjs.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\onvif.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #41.pymystrom
    command = [r'SDK_dataset\pymystrom\bulb.py',
        r'SDK_dataset\pymystrom\__init__.py']
    with open('RQ1-2\\PyCG_results\\pymystrom.txt', 'w') as file:
        file.write(str(run_script(command).stdout))


    #42.aiolifx
    command = [r'SDK_dataset\aiolifx\aiolifx.py']
    with open('RQ1-2\\PyCG_results\\aiolifx.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #43.tellduslive
    command = [r'SDK_dataset\tellduslive\tellduslive.py']
    with open('RQ1-2\\PyCG_results\\tellduslive.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
    ...
    with open('RQ1-2\\PyCG_results\\pysensibo.txt', 'w') as file:
        file.write(str(run_script(command).stdout))

    #45.ttls
    command = [r'SDK_dataset\ttls\client.py']
    with open('RQ1-2\\PyCG_results\\ttls.txt', 'w') as file:
        file.write(str(run_script(command).stdout))
