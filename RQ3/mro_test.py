...
if __name__ == "__main__":
    ...
    test_path = r'micro-benchmark\mro'
    categories = [r'\basic', r'\basic_init', r'\parents_same_superclass', r'\self_assignment', r'\super_call', r'\two_parents', 
                  r'\two_parents_method_defined']
